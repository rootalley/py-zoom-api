...
class Body(object):
    ...
    @property
    def domain(self):
        """Gets the domain of this Body.  # noqa: E501

        The name or IP address of your provider’s SIP domain. (example: CDC.WEB).  # noqa: E501

        :return: The domain of this Body.  # noqa: E501
        :rtype: str
        """
        return self._domain
    ...
    def domain(self, domain):
        """Sets the domain of this Body.

        The name or IP address of your provider’s SIP domain. (example: CDC.WEB).  # noqa: E501

        :param domain: The domain of this Body.  # noqa: E501
        :type: str
        """
        if domain is None:
    ...
    def register_server(self):
        """Gets the register_server of this Body.  # noqa: E501
        ...
        :return: The register_server of this Body.  # noqa: E501
        :rtype: str
        """
    ...
    def register_server(self, register_server):
        """Sets the register_server of this Body.

        IP address of the server that accepts REGISTER requests. Note that if you are using the UDP transport protocol, the default port is 5060. If you are using UDP with a different port number, that port number must be included with the IP address.  # noqa: E501

        :param register_server: The register_server of this Body.  # noqa: E501
        :type: str
        """
    ...
    def transport_protocol(self):
        """Gets the transport_protocol of this Body.  # noqa: E501

        Protocols supported by the SIP provider.<br> The value must be either `UDP`, `TCP`, `TLS`, `AUTO`.  # noqa: E501

        :return: The transport_protocol of this Body.  # noqa: E501
        :rtype: str
        """
    ...
    def transport_protocol(self, transport_protocol):
        """Sets the transport_protocol of this Body.

        Protocols supported by the SIP provider.<br> The value must be either `UDP`, `TCP`, `TLS`, `AUTO`.  # noqa: E501

        :param transport_protocol: The transport_protocol of this Body.  # noqa: E501
        :type: str
        """
    ...
    def proxy_server(self):
        """Gets the proxy_server of this Body.  # noqa: E501
        ...
        :return: The proxy_server of this Body.  # noqa: E501
        :rtype: str
        """
    ...
    def proxy_server(self, proxy_server):
        """Sets the proxy_server of this Body.

        IP address of the proxy server for SIP requests. Note that if you are using the UDP transport protocol, the default port is 5060. If you are using UDP with a different port number, that port number must be included with the IP address. If you are not using a proxy server, this value can be the same as the Register Server.  # noqa: E501

        :param proxy_server: The proxy_server of this Body.  # noqa: E501
        :type: str
        """
    ...
    def register_server2(self):
        """Gets the register_server2 of this Body.  # noqa: E501

        IP address of the server that accepts REGISTER requests. Note that if you are using the UDP transport protocol, the default port is 5060. If you are using UDP with a different port number, that port number must be included with the IP address.  # noqa: E501

        :return: The register_server2 of this Body.  # noqa: E501
        :rtype: str
        """
    ...
    def register_server2(self, register_server2):
        """Sets the register_server2 of this Body.

        IP address of the server that accepts REGISTER requests. Note that if you are using the UDP transport protocol, the default port is 5060. If you are using UDP with a different port number, that port number must be included with the IP address.  # noqa: E501

        :param register_server2: The register_server2 of this Body.  # noqa: E501
        :type: str
        """
    ...
    def transport_protocol2(self):
        """Gets the transport_protocol2 of this Body.  # noqa: E501

        Protocols supported by the SIP provider.<br> The value must be either `UDP`, `TCP`, `TLS`, `AUTO`.  # noqa: E501

        :return: The transport_protocol2 of this Body.  # noqa: E501
        :rtype: str
        """
    ...
    def transport_protocol2(self, transport_protocol2):
        """Sets the transport_protocol2 of this Body.

        Protocols supported by the SIP provider.<br> The value must be either `UDP`, `TCP`, `TLS`, `AUTO`.  # noqa: E501

        :param transport_protocol2: The transport_protocol2 of this Body.  # noqa: E501
        :type: str
        """
        allowed_values = ["UDP", "TCP", "TLS", "AUTO"]  # noqa: E501
    ...
    def proxy_server2(self):
        """Gets the proxy_server2 of this Body.  # noqa: E501
        ...
        :return: The proxy_server2 of this Body.  # noqa: E501
        :rtype: str
        """
    ...
    def proxy_server2(self, proxy_server2):
        """Sets the proxy_server2 of this Body.

        IP address of the proxy server for SIP requests. Note that if you are using the UDP transport protocol, the default port is 5060. If you are using UDP with a different port number, that port number must be included with the IP address. If you are not using a proxy server, this value can be the same as the Register Server, or empty.  # noqa: E501

        :param proxy_server2: The proxy_server2 of this Body.  # noqa: E501
        :type: str
        """
    ...
    def register_server3(self):
        """Gets the register_server3 of this Body.  # noqa: E501

        IP address of the server that accepts REGISTER requests. Note that if you are using the UDP transport protocol, the default port is 5060. If you are using UDP with a different port number, that port number must be included with the IP address.  # noqa: E501

        :return: The register_server3 of this Body.  # noqa: E501
        :rtype: str
        """
    ...
    def register_server3(self, register_server3):
        """Sets the register_server3 of this Body.

        IP address of the server that accepts REGISTER requests. Note that if you are using the UDP transport protocol, the default port is 5060. If you are using UDP with a different port number, that port number must be included with the IP address.  # noqa: E501

        :param register_server3: The register_server3 of this Body.  # noqa: E501
        :type: str
        """
    ...
    def transport_protocol3(self):
        """Gets the transport_protocol3 of this Body.  # noqa: E501

        Protocols supported by the SIP provider.<br> The value must be either `UDP`, `TCP`, `TLS`, `AUTO`.  # noqa: E501

        :return: The transport_protocol3 of this Body.  # noqa: E501
        :rtype: str
        """
    ...
    def transport_protocol3(self, transport_protocol3):
        """Sets the transport_protocol3 of this Body.

        Protocols supported by the SIP provider.<br> The value must be either `UDP`, `TCP`, `TLS`, `AUTO`.  # noqa: E501

        :param transport_protocol3: The transport_protocol3 of this Body.  # noqa: E501
        :type: str
        """
        allowed_values = ["UDP", "TCP", "TLS", "AUTO"]  # noqa: E501
    ...
    def proxy_server3(self):
        """Gets the proxy_server3 of this Body.  # noqa: E501

        IP address of the proxy server for SIP requests. Note that if you are using the UDP transport protocol, the default port is 5060. If you are using UDP with a different port number, that port number must be included with the IP address. If you are not using a proxy server, this value can be the same as the Register Server, or empty.  # noqa: E501

        :return: The proxy_server3 of this Body.  # noqa: E501
        :rtype: str
        """
    ...
    def proxy_server3(self, proxy_server3):
        """Sets the proxy_server3 of this Body.

        IP address of the proxy server for SIP requests. Note that if you are using the UDP transport protocol, the default port is 5060. If you are using UDP with a different port number, that port number must be included with the IP address. If you are not using a proxy server, this value can be the same as the Register Server, or empty.  # noqa: E501

        :param proxy_server3: The proxy_server3 of this Body.  # noqa: E501
        :type: str
        """
    ...
    def registration_expire_time(self):
        """Gets the registration_expire_time of this Body.  # noqa: E501
        ...
        :return: The registration_expire_time of this Body.  # noqa: E501
        :rtype: int
        """
    ...
    def registration_expire_time(self, registration_expire_time):
        """Sets the registration_expire_time of this Body.

        The number of minutes after which the SIP registration of the Zoom client user will expire, and the client will auto register to the SIP server.  # noqa: E501

        :param registration_expire_time: The registration_expire_time of this Body.  # noqa: E501
        :type: int
        """
    ...
    def authorization_name(self):
        """Gets the authorization_name of this Body.  # noqa: E501

        Authorization name of the user  registered for SIP Phone.  # noqa: E501

        :return: The authorization_name of this Body.  # noqa: E501
        :rtype: str
        """
    ...
    def authorization_name(self, authorization_name):
        """Sets the authorization_name of this Body.

        Authorization name of the user  registered for SIP Phone.  # noqa: E501

        :param authorization_name: The authorization_name of this Body.  # noqa: E501
        :type: str
        """
    ...
    @property
    def voice_mail(self):
        """Gets the voice_mail of this Body.  # noqa: E501

        The number to dial for checking voicemail.  # noqa: E501

        :return: The voice_mail of this Body.  # noqa: E501
        :rtype: str
        """
    ...
    def voice_mail(self, voice_mail):
        """Sets the voice_mail of this Body.

        The number to dial for checking voicemail.  # noqa: E501

        :param voice_mail: The voice_mail of this Body.  # noqa: E501
        :type: str
        """
