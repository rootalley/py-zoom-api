...
class Body46(object):
    ...
    @property
    def topic(self):
        """Gets the topic of this Body46.  # noqa: E501

        Meeting topic.  # noqa: E501

        :return: The topic of this Body46.  # noqa: E501
        :rtype: str
        """
        return self._topic
    ...
    def topic(self, topic):
        """Sets the topic of this Body46.

        Meeting topic.  # noqa: E501

        :param topic: The topic of this Body46.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this Body46.  # noqa: E501
        ...
        :return: The type of this Body46.  # noqa: E501
        :rtype: int
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this Body46.

        Meeting Type:<br>`1` - Instant meeting.<br>`2` - Scheduled meeting.<br>`3` - Recurring meeting with no fixed time.<br>`8` - Recurring meeting with fixed time.  # noqa: E501

        :param type: The type of this Body46.  # noqa: E501
        :type: int
        """
    ...
    @property
    def start_time(self):
        """Gets the start_time of this Body46.  # noqa: E501
        ...
        :return: The start_time of this Body46.  # noqa: E501
        :rtype: datetime
        """
    ...
    def start_time(self, start_time):
        """Sets the start_time of this Body46.

        Meeting start time. We support two formats for `start_time` - local time and GMT.<br>   To set time as GMT the format should be `yyyy-MM-dd`T`HH:mm:ssZ`. Example: \"2020-03-31T12:02:00Z\"  To set time using a specific timezone, use `yyyy-MM-dd`T`HH:mm:ss` format and specify the timezone [ID](https://marketplace.zoom.us/docs/api-reference/other-references/abbreviation-lists#timezones) in the `timezone` field OR leave it blank and the timezone set on your Zoom account will be used. You can also set the time as UTC as the timezone field.  The `start_time` should only be used for scheduled and / or recurring webinars with fixed time.  # noqa: E501

        :param start_time: The start_time of this Body46.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def duration(self):
        """Gets the duration of this Body46.  # noqa: E501

        Meeting duration (minutes). Used for scheduled meetings only.  # noqa: E501

        :return: The duration of this Body46.  # noqa: E501
        :rtype: int
        """
    ...
    def duration(self, duration):
        """Sets the duration of this Body46.

        Meeting duration (minutes). Used for scheduled meetings only.  # noqa: E501

        :param duration: The duration of this Body46.  # noqa: E501
        :type: int
        """
    ...
    def schedule_for(self):
        """Gets the schedule_for of this Body46.  # noqa: E501
        ...
        :return: The schedule_for of this Body46.  # noqa: E501
        :rtype: str
        """
    ...
    def schedule_for(self, schedule_for):
        """Sets the schedule_for of this Body46.

        If you would like to schedule this meeting for someone else in your account, provide the Zoom user id or email address of the user here.  # noqa: E501

        :param schedule_for: The schedule_for of this Body46.  # noqa: E501
        :type: str
        """
    ...
    @property
    def timezone(self):
        """Gets the timezone of this Body46.  # noqa: E501
        ...
        :return: The timezone of this Body46.  # noqa: E501
        :rtype: str
        """
    ...
    def timezone(self, timezone):
        """Sets the timezone of this Body46.

        Time zone to format start_time. For example, \"America/Los_Angeles\". For scheduled meetings only. Please reference our [time zone](https://marketplace.zoom.us/docs/api-reference/other-references/abbreviation-lists#timezones) list for supported time zones and their formats.  # noqa: E501

        :param timezone: The timezone of this Body46.  # noqa: E501
        :type: str
        """
    ...
    @property
    def password(self):
        """Gets the password of this Body46.  # noqa: E501
        ...
        :return: The password of this Body46.  # noqa: E501
        :rtype: str
        """
    ...
    def password(self, password):
        """Sets the password of this Body46.

        Password to join the meeting. By default, password may only contain the following characters: [a-z A-Z 0-9 @ - _ *] and can have a maximum of 10 characters.  **Note:** If the account owner or the admin has configured [minimum password requirement settings](https://support.zoom.us/hc/en-us/articles/360033559832-Meeting-and-webinar-passwords#h_a427384b-e383-4f80-864d-794bf0a37604), the password value provided here must meet those requirements. <br><br>If the requirements are enabled, you can view those requirements by calling either the [Get User Settings API](https://marketplace.zoom.us/docs/api-reference/zoom-api/users/usersettings) or the [Get Account Settings](https://marketplace.zoom.us/docs/api-reference/zoom-api/accounts/accountsettings) API.   # noqa: E501

        :param password: The password of this Body46.  # noqa: E501
        :type: str
        """
    ...
    @property
    def agenda(self):
        """Gets the agenda of this Body46.  # noqa: E501

        Meeting description.  # noqa: E501

        :return: The agenda of this Body46.  # noqa: E501
        :rtype: str
        """
        return self._agenda
    ...
    def agenda(self, agenda):
        """Sets the agenda of this Body46.

        Meeting description.  # noqa: E501

        :param agenda: The agenda of this Body46.  # noqa: E501
        :type: str
        """
    ...
    def tracking_fields(self):
        """Gets the tracking_fields of this Body46.  # noqa: E501

        Tracking fields  # noqa: E501

        :return: The tracking_fields of this Body46.  # noqa: E501
    ...
    def tracking_fields(self, tracking_fields):
        """Sets the tracking_fields of this Body46.

        Tracking fields  # noqa: E501

        :param tracking_fields: The tracking_fields of this Body46.  # noqa: E501
    ...
    @property
    def recurrence(self):
        """Gets the recurrence of this Body46.  # noqa: E501


        :return: The recurrence of this Body46.  # noqa: E501
    ...
    def recurrence(self, recurrence):
        """Sets the recurrence of this Body46.


        :param recurrence: The recurrence of this Body46.  # noqa: E501
    ...
    @property
    def settings(self):
        """Gets the settings of this Body46.  # noqa: E501


        :return: The settings of this Body46.  # noqa: E501
    ...
    def settings(self, settings):
        """Sets the settings of this Body46.


        :param settings: The settings of this Body46.  # noqa: E501
