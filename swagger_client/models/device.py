...
class Device(object):
    ...
    @property
    def protocol(self):
        """Gets the protocol of this Device.  # noqa: E501

        Device protocol:<br>`H.323` - H.323.<br>`SIP` - SIP.  # noqa: E501

        :return: The protocol of this Device.  # noqa: E501
        :rtype: str
        """
    ...
    def protocol(self, protocol):
        ...
        :param protocol: The protocol of this Device.  # noqa: E501
        :type: str
        """
        if protocol is None:
    ...
    @property
    def encryption(self):
        """Gets the encryption of this Device.  # noqa: E501

        Device encryption:<br>`auto` - auto.<br>`yes` - yes.<br>`no` - no.  # noqa: E501

        :return: The encryption of this Device.  # noqa: E501
        :rtype: str
        """
    ...
    def encryption(self, encryption):
        """Sets the encryption of this Device.

        Device encryption:<br>`auto` - auto.<br>`yes` - yes.<br>`no` - no.  # noqa: E501

        :param encryption: The encryption of this Device.  # noqa: E501
        :type: str
        """
