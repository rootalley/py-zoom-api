...
class Body79(object):
    ...
    @property
    def action(self):
        """Gets the action of this Body79.  # noqa: E501
        ...
        :return: The action of this Body79.  # noqa: E501
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        """Sets the action of this Body79.

        Specify how to create the new user: <br>`create` - User will get an email sent from Zoom. There is a confirmation link in this email. The user will then need to use the link to activate their Zoom account. The user can then set or change their password.<br>`autoCreate` - This action is provided for the enterprise customer who has a managed domain. This feature is disabled by default because of the security risk involved in creating a user who does not belong to your domain.<br>`custCreate` - Users created via this option do not have passwords and will not have the ability to log into the Zoom Web Portal or the Zoom Client. These users can still host and join meetings using the `start_url` and `join_url` respectively. To use this option, you must contact the ISV Platform Sales team at isv@zoom.us.<br>`ssoCreate` - This action is provided for the enabled “Pre-provisioning SSO User” option. A user created in this way has no password. If not a basic user, a personal vanity URL using the user name (no domain) of the provisioning email will be generated. If the user name or PMI is invalid or occupied, it will use a random number or random personal vanity URL.  # noqa: E501

        :param action: The action of this Body79.  # noqa: E501
        :type: str
        """
        if action is None:
    ...
    @property
    def user_info(self):
        """Gets the user_info of this Body79.  # noqa: E501


        :return: The user_info of this Body79.  # noqa: E501
        :rtype: UsersUserInfo
        """
    ...
    def user_info(self, user_info):
        """Sets the user_info of this Body79.


        :param user_info: The user_info of this Body79.  # noqa: E501
        :type: UsersUserInfo
        """
