...
class Body43(object):
    ...
    @property
    def name(self):
        """Gets the name of this Body43.  # noqa: E501

        Group name: must be unique to one account.  # noqa: E501

        :return: The name of this Body43.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this Body43.

        Group name: must be unique to one account.  # noqa: E501

        :param name: The name of this Body43.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this Body43.  # noqa: E501
        ...
        :return: The type of this Body43.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this Body43.

        IM Group types:<br>`normal` - Only group members can automatically see others in their group. Other people can search for members in the group.<br>`shared` - Everyone under the account can see the group and members automatically.<br>`restricted` - Nobody can see the group or search for members except for the members in the group.  # noqa: E501

        :param type: The type of this Body43.  # noqa: E501
        :type: str
        """
    ...
    def search_by_domain(self):
        """Gets the search_by_domain of this Body43.  # noqa: E501

        Members can search for others in the same email domain.  # noqa: E501

        :return: The search_by_domain of this Body43.  # noqa: E501
        :rtype: bool
        """
    ...
    def search_by_domain(self, search_by_domain):
        """Sets the search_by_domain of this Body43.

        Members can search for others in the same email domain.  # noqa: E501

        :param search_by_domain: The search_by_domain of this Body43.  # noqa: E501
        :type: bool
        """
    ...
    def search_by_account(self):
        """Gets the search_by_account of this Body43.  # noqa: E501

        Members can search for others under same account.  # noqa: E501

        :return: The search_by_account of this Body43.  # noqa: E501
        :rtype: bool
        """
    ...
    def search_by_account(self, search_by_account):
        """Sets the search_by_account of this Body43.

        Members can search for others under same account.  # noqa: E501

        :param search_by_account: The search_by_account of this Body43.  # noqa: E501
        :type: bool
        """
    ...
    def search_by_ma_account(self):
        """Gets the search_by_ma_account of this Body43.  # noqa: E501

        Members can search for others under same master account, including all sub accounts.  # noqa: E501

        :return: The search_by_ma_account of this Body43.  # noqa: E501
        :rtype: bool
        """
    ...
    def search_by_ma_account(self, search_by_ma_account):
        """Sets the search_by_ma_account of this Body43.

        Members can search for others under same master account, including all sub accounts.  # noqa: E501

        :param search_by_ma_account: The search_by_ma_account of this Body43.  # noqa: E501
        :type: bool
        """
