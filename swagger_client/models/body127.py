...
class Body127(object):
    ...
    def action(self, action):
        """Sets the action of this Body127.

        The action that needs to be taken for this sub account. Value must be set to \"cancel\".  # noqa: E501

        :param action: The action of this Body127.  # noqa: E501
        :type: str
        """
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this Body127.

        Plan [type](https://marketplace.zoom.us/docs/api-reference/other-references/plans).  # noqa: E501

        :param type: The type of this Body127.  # noqa: E501
        :type: str
        """
    ...
    @property
    def reason(self):
        """Gets the reason of this Body127.  # noqa: E501
        ...
        :return: The reason of this Body127.  # noqa: E501
        :rtype: int
        """
        return self._reason
    ...
    def reason(self, reason):
        """Sets the reason of this Body127.

        The reason for the cancellation of plan. Reason options:<br>`1` - Only needed the service occasionally.<br>`2` - Features in the free plan are sufficient.<br>`3` - The plan is too expensive.<br>`4` - Important features are missing.<br>`5` - I need help to better use Zoom.<br> `6` - I bought the wrong product.<br>`7` - I am not satisfied with the product quality.  # noqa: E501

        :param reason: The reason of this Body127.  # noqa: E501
        :type: int
        """
    ...
    @property
    def comment(self):
        """Gets the comment of this Body127.  # noqa: E501

        Additional comments about the cancellation decision.  # noqa: E501

        :return: The comment of this Body127.  # noqa: E501
        :rtype: str
        """
    ...
    def comment(self, comment):
        """Sets the comment of this Body127.

        Additional comments about the cancellation decision.  # noqa: E501

        :param comment: The comment of this Body127.  # noqa: E501
        :type: str
        """
